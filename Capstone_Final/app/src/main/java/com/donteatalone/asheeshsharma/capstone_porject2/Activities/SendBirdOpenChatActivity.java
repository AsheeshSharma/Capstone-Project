...
//        SendBird.notifyActivityPausedForOldAndroids();
        ...
        switch (requestCode) {
            case Helper.MY_PERMISSION_REQUEST_STORAGE:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED &&
                    ...
                    Toast.makeText(this, getString(R.string.p_g), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(this, getString(R.string.p_d), Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
    ...
    public static class SendBirdChatFragment extends Fragment {
        ...
        private void upload(Uri uri) {
            ...
            if (path == null) {
                Toast.makeText(getActivity(), getString(R.string.up_e), Toast.LENGTH_LONG).show();
            } else {
