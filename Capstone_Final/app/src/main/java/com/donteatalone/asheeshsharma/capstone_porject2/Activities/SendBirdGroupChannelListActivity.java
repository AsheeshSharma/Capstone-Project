...
public class SendBirdGroupChannelListActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, getString(R.string.msg_le), Toast.LENGTH_LONG).show();
    }
        ...
        findViewById(R.id.btn_version).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(SendBirdGroupChannelListActivity.this)
                        .setTitle(getString(R.string.sb_))
                        .setMessage(getString(R.string.sb_s) + SendBird.getSDKVersion())
            ...
            mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                    ...
                    new AlertDialog.Builder(getActivity())
                            .setTitle("Leave")
                            .setMessage(getString(R.string.ch_m))
                            .setPositiveButton(getString(R.string.ch_le), new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    channel.leave(new GroupChannel.GroupChannelLeaveHandler() {
                                        ...
                                        public void onResult(SendBirdException e) {
                                            ...
                                            Toast.makeText(getActivity(), getString(R.string.ch_l), Toast.LENGTH_SHORT).show();
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    channel.hide(new GroupChannel.GroupChannelHideHandler() {
                                        ...
                                        public void onResult(SendBirdException e) {
                                            ...
                                            Toast.makeText(getActivity(), getString(R.string.ch_h), Toast.LENGTH_SHORT).show();
                                            mAdapter.remove(position);
                                            mAdapter.notifyDataSetChanged();
                                        }
                                    });
